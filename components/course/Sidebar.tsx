...
//         {!isCollapsible && (
//           <span className="text-white text-lg  font-bold">CODE HELP</span>
//         )}
//       </div>
...
//               href={item.href}
//             >
//               <Image src={item.img} alt="img" width={20} height={20} />
//               {!isCollapsible && <div className="w-full">{item.label}</div>}
//             </Link>
//           </Button>
//         ))}
//       </div>
...
//           href="#"
//         >
//           <Image src="/discord-logo.png" alt="img" width={20} height={20} />
//           {!isCollapsible && <div>Join Discord</div>}
//         </Link>
...
//         hover:bg-[#1E1E1E]"
//         >
//           <Image src="/moon.png" alt="img" width={20} height={20} />
//           {!isCollapsible && <div>Night Mode</div>}
//         </button>
...
//             width={24}
//             height={24}
//             className="rounded-[999999986991104px]"
//           />
//           {!isCollapsible && (
//             <>
